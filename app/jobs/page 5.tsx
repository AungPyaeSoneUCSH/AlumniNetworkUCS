      ...
      <div className="border-b border-[var(--ucsh-border)] p-3">
        <div className="flex items-start justify-between gap-3">
          <div className="min-w-0">
            ...
            <p className="mt-1 flex items-center gap-1 text-[10px] font-semibold text-[var(--ucsh-muted)] sm:text-[11px]">
              <User size={10} />
              <span className="truncate">{experienceLabel}</span>
            </p>
          </div>

          <div className="flex h-9 w-9 shrink-0 items-center justify-center rounded-xl bg-cyan-50 text-[var(--ucsh-primary-dark)] ring-1 ring-cyan-200 dark:bg-cyan-950/40 dark:ring-cyan-900">
            <User size={17} />
          </div>
        </div>
      </div>
