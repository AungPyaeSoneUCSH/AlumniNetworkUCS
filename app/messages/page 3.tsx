...
import { ArrowLeft, MessageCircle, Search, Send, UserRound, ShieldAlert } from "lucide-react";
...
export default function MessagesPage() {
  ...
  async function sendMessage() {
    ...
    // Double check permission before hitting the API
  ...
  // Filter out self, apply search, and restrict admin visibility
  const filteredUsers = useMemo(() => {
    ...
    return users
      ...
      .filter((user) => {
        // If I am NOT an admin, hide users who ARE admins
  ...
  // Determine if current open chat is locked down for this user
