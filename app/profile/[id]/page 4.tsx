...
export default function ProfilePage() {
  ...
  if (!profileData) {
    return (
      <main className="flex min-h-screen items-center justify-center px-4 text-center text-sm font-bold text-slate-500">
  ...
  return (
    <section className="min-h-screen  px-10 py-4 text-slate-950 sm:px-4">
      <div className="fixed bottom-6 right-12 z-50">
        <button
          type="button"
          onClick={handleBack}
          aria-label={t.back}
          className="inline-flex h-11 w-11 items-center justify-center rounded-full border border-white/70 bg-[#25C9C8]/95 text-slate-700 shadow-lg shadow-slate-900/10 backdrop-blur transition hover:-translate-y-0.5 hover:bg-[#25C9C8] hover:text-white active:scale-95 sm:left-6 sm:h-12 sm:w-12"
        >
      ...
      <div className="mx-auto w-full max-w-5xl space-y-4">
        <header className="overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-sm">
          <div className="relative h-20 bg-gradient-to-br from-[#00BFC4] via-[#77edec] to-[#339e9e] sm:h-32">
                ...
                >
                    ...
                    <div className="flex min-w-0 items-center gap-2.5">
                      ...
                      <div className="min-w-0">
                        <Link
                          ...
                          className="block truncate text-sm font-black text-slate-950 hover:underline"
                        >
                          {profileData.name || t.unknownAlumni}
                        </Link>
                  ...
                  <div className="mt-2 flex border-t border-slate-100 pt-1 text-xs font-bold text-slate-600">
                    <button
                      ...
                      className={`flex flex-1 items-center justify-center gap-2 rounded-xl py-2 transition hover:bg-slate-50 ${post.likedByMe ? "text-[#1877F2]" : ""}`}
                    >
                      <FaThumbsUp /> {t.like}
                    </button>
                    <button
                      ...
                      className="flex flex-1 items-center justify-center gap-2 rounded-xl py-2 transition hover:bg-slate-50"
                    >
                      <FaComment /> {t.comment}
                    </button>
                  </div>
                    ...
                    <div className="mt-3 space-y-3 border-t border-slate-100 pt-3">
                      <div className="flex items-center gap-2">
                        ...
                        <button
                          ...
                          className="flex h-9 w-9 items-center justify-center rounded-full bg-[#25C9C8] text-white transition hover:bg-[#008B8B]"
                        >
                          ...
                          post.comments.map((comment: any, index: number) => (
                            ...
                            >
                              ...
                              <div className="max-w-full rounded-2xl bg-slate-50 px-3 py-2 text-xs">
                                ...
                                <p className="mt-0.5 whitespace-pre-line break-words font-semibold leading-5 text-slate-700">
...
function Card({
  ...
  return (
    ...
    >
      <h2 className="mb-3 text-xs font-black uppercase tracking-wider text-slate-950">
        {title}
      </h2>
      {children}
    </section>
...
function PostContentBody({ content, t }: { content?: string; t: any }) {
  ...
  return (
    <div className="mt-3">
      <p
        className={`whitespace-pre-line break-words text-sm font-medium leading-6 text-slate-800 ${!isExpanded ? "line-clamp-5" : ""}`}
      >
        {content}
      </p>
      {shouldClamp && (
        <button
          ...
          className="mt-1 text-xs font-black text-[#1877F2] hover:underline"
        >
  ...
  return (
    <article className="rounded-2xl border border-slate-100 bg-slate-50/60 p-4 transition hover:border-slate-200 hover:bg-white">
      <div className="flex gap-3">
        <div className="flex h-9 w-9 shrink-0 items-center justify-center rounded-xl bg-[#E7F3FF] text-xs font-black text-[#1877F2]">
          {index}
        </div>
...
function InfoBox({
  ...
  return (
    <div className="flex items-center gap-3 rounded-2xl border border-slate-100 bg-slate-50 p-3">
      <span className="flex h-9 w-9 shrink-0 items-center justify-center rounded-full bg-white text-[#1877F2] shadow-sm">
        {icon}
      </span>
      <div className="min-w-0">
...
function ContactLink({
  ...
  return (
    <a
      href={normalizeUrl(href)}
      className="flex items-center gap-3 rounded-2xl border border-slate-100 bg-slate-50 p-3 transition hover:bg-slate-100"
    >
      <span className="flex h-9 w-9 shrink-0 items-center justify-center rounded-full bg-white text-[#1877F2] shadow-sm">
        {icon}
      </span>
