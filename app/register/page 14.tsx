...
export default function RegisterPage() {
  ...
  // NOTE: Default graduatedYear is initialized to "2026", which is safely within our [2007 -> currentYear + 1] range
  ...
  // CHANGED: Generate dynamic array of graduated years starting from 2007 up to (current year + 1).
  // Sorted descending so the most recent/relevant years appear first in the select box options.
  ...
  return (
    <main className="min-h-[calc(100vh-70px)] px-2 pb-6 pt-6 sm:px-3">
      <section className="relative mx-auto grid max-w-7xl overflow-hidden rounded-2xl border border-white/20 bg-gradient-to-br from-[#3a6968] via-white to-[#eaffff] shadow-md lg:grid-cols-[0.95fr_1.05fr]">
        ...
        {/* Left Column: Branding matching app/page.tsx & app/login/page.tsx */}
            ...
            {step === "approval" && (
              <div className="space-y-4">
                <div className="grid gap-4 sm:grid-cols-2">
                  ...
                  {/* CHANGED: Replaced number Input with a Select option box mapping over dynamic graduatedYears */}
                  <Select
