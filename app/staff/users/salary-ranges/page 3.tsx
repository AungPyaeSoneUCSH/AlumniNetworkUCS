...
<div class="legend">
<span><i class="dot" style="background:${MIN_BAR_COLOR}"></i>${escapeHtml(t.min)}</span>
<span><i class="dot" style="background:${MAX_BAR_COLOR}"></i>${escapeHtml(t.max)}</span>
</div>
            ...
            <section className="overflow-hidden rounded-2xl border border-slate-200/80 bg-white shadow-sm dark:border-slate-800/80 dark:bg-slate-900/50">
              ...
              {salaryItems.length === 0 ? (
                ...
                <div className="overflow-x-auto overflow-y-hidden p-3 sm:p-5 md:p-6">
                  <div className="relative min-w-[680px] rounded-2xl bg-slate-50/80 p-3 dark:bg-slate-950/50 sm:min-w-[760px] sm:p-5">
                    ...
                    <div className="mb-4 flex flex-wrap gap-4 pl-8 text-[11px] font-black text-slate-600 dark:text-slate-300">
                      <Legend color={MIN_BAR_COLOR} label={t.min} />
                      <Legend color={MAX_BAR_COLOR} label={t.max} />
                    </div>
