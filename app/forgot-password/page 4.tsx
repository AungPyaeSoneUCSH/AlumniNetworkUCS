            ...
            {step === "otp" && (
              <form onSubmit={verifyOtp} className="relative space-y-5">
                ...
                <PrimaryButton disabled={otpCode.length !== OTP_LENGTH}>
                  {currentLang === "mm" ? "ဆက်မည်" : "Continue"}
                </PrimaryButton>
                ...
                >
                  {currentLang === "mm" ? "Email ပြန်ပြင်မည်" : "Change email"}
                </BackButton>
              </form>
            )}
            ...
            {step === "success" && (
              <div className="relative text-center">
                ...
                <p className="mt-3 text-sm font-bold leading-relaxed text-[var(--ucsh-muted)]">
                  {currentLang === "mm"
                    ? "Auto login မအောင်မြင်ပါ။ ပြန်ဝင်ရောက်ပါ။"
                    : "Auto login failed. Please login again."}
                </p>
