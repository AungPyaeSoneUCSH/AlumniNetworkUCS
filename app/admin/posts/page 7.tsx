...
import { MessageCircle, Newspaper, Search, Trash2 } from "lucide-react";
...
import PostsPrintExport, {
  type PostExportRow,
} from "@/components/admin/posts_print_export";
...
export default async function AdminPostsPage({
  ...
  const exportRows: PostExportRow[] = makeExportRows(filteredPosts, t).map(
    (row, index) => ({
      no: index + 1,
      author: row.author,
      email: row.email,
            ...
            <div className="relative z-20 overflow-visible rounded-2xl border border-slate-200/80 bg-white p-4 shadow-sm dark:border-slate-800/80 dark:bg-slate-900/50 sm:p-5">
              <div className="flex flex-col gap-4 lg:flex-row lg:items-start lg:justify-between">
                ...
                <div className="relative z-50 flex w-full flex-wrap items-center gap-2 overflow-visible lg:w-auto lg:justify-end">
                  <PostsPrintExport rows={exportRows} labels={exportLabels} />
                </div>
              </div>
