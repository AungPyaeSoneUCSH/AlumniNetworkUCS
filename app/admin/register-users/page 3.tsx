              ...
              <div className="w-full overflow-x-auto rounded-2xl">
                <table className="min-w-[920px] w-full border-separate border-spacing-0">
                  <thead className="bg-slate-50 dark:bg-slate-950">
                    <tr>
                      <TableHead className="w-[38%]">{t.user}</TableHead>
                      <TableHead className="w-[18%]">{t.phone}</TableHead>
                      <TableHead className="w-[18%]">{t.degree}</TableHead>
                      <TableHead className="w-[11%]">{t.year}</TableHead>
                  ...
                  <tbody>
                    {filteredUsers.map((user) => (
                      ...
                      >
                        <td className="border-t border-slate-100 px-3 py-2 align-middle dark:border-slate-800">
                          <UserCell user={user} t={t} />
                        </td>

                        <td className="border-t border-slate-100 px-3 py-2 align-middle text-xs font-black text-slate-700 dark:border-slate-800 dark:text-slate-200">
                          {getPhone(user, t)}
                        </td>
                        ...
                        <td className="border-t border-slate-100 px-3 py-2 align-middle text-xs font-black dark:border-slate-800">
                          {getGraduatedYear(user, t)}
                        </td>
                        ...
                        <td className="border-t border-slate-100 px-3 py-2 align-middle dark:border-slate-800">
                          <div className="flex justify-end gap-1.5">
                            <form action={deleteUserAccount}>
                              ...
                              />
                              <button className="inline-flex items-center gap-1.5 rounded-lg bg-red-500 px-2.5 py-1.5 text-[11px] font-black text-white shadow-sm transition hover:bg-red-600">
                                <Trash2 size={13} />
                                {t.delete}
                              </button>
                            </form>
...
function TableHead({
  ...
  return (
    <th
      className={`${className} px-3 py-2.5 ${
        align === "right" ? "text-right" : "text-left"
      } text-[11px] font-black uppercase tracking-[0.14em] text-slate-400`}
    >
      {children}
    </th>
  );
  ...
  return (
    <div className="flex min-w-0 items-center gap-2.5">
      ...
      <div className="min-w-0">
        ...
        <p className="mt-0.5 flex min-w-0 items-center gap-1.5 text-[11px] font-bold text-slate-400">
          <Mail size={12} />
