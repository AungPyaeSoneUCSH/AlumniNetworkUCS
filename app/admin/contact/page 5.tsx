      ...
      <div className="flex flex-col gap-2 border-b border-slate-200 bg-white px-3 py-3 dark:border-slate-800 dark:bg-slate-900 sm:flex-row sm:items-center sm:justify-between">
        ...
        {safeMapUrl && (
          <a
            ...
            target="_blank"
            rel="noreferrer"
            className="inline-flex shrink-0 items-center justify-center gap-2 rounded-2xl border border-[#00BFC4]/30 bg-[#EFFFFF] px-3.5 py-2 text-xs font-black text-[#008B8B] transition hover:bg-[#DFFFFF] dark:bg-[#00BFC4]/10 dark:hover:bg-[#00BFC4]/15"
          >
