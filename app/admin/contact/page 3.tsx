      ...
      <div className="flex min-h-screen">
        ...
        <section className="min-w-0 flex-1 px-3 pb-6 pt-20 sm:px-5 lg:px-7 lg:pt-7">
          <div className="mx-auto max-w-6xl">
            {loading ? (
              <div className="flex min-h-[360px] items-center justify-center rounded-[26px] border border-slate-200 bg-white shadow-lg shadow-slate-200/60 dark:border-slate-800 dark:bg-slate-900">
                <Loader2 className="h-9 w-9 animate-spin text-[#008B8B]" />
              </div>
            ) : (
              <form
                onSubmit={submit}
                className="overflow-hidden rounded-[26px] border border-slate-200 bg-white shadow-lg shadow-slate-200/60 dark:border-slate-800 dark:bg-slate-900"
              >
...
function IconBox({ children }: { children: React.ReactNode }) {
  return (
    <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-2xl bg-gradient-to-br from-[#00BFC4] to-[#008B8B] text-white shadow-lg shadow-cyan-500/20">
      {children}
    </div>
  );
}
...
function InputCard({
  ...
  return (
    <label className="block rounded-[22px] border border-slate-200 bg-slate-50 p-3 shadow-sm transition focus-within:border-[#25C9C8] focus-within:bg-white dark:border-slate-800 dark:bg-slate-950/60 dark:focus-within:bg-slate-950 sm:p-4">
