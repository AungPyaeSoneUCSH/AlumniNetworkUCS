...
const text = {
  en: {
    ...
    salaryRangeByPosition: "Income Range by Position",
    ...
    subtitleSalary: "",
   // subtitleJob:      "Shows graduates who have jobs or do not have jobs within selected years.",
   subtitleJob: "",
    ...
    noSalary: "No income and position data found.",
  ...
  mm: {
    ...
    //subtitleSalary: "အနိမ့်ဆုံးလစာနှင့် အမြင့်ဆုံးလစာကို vertical graph ဖြင့် ပြထားသည်။",
    subtitleSalary: "",
    //subtitleJob:       "ရွေးချယ်ထားသော ခုနှစ်အတွင်း အလုပ်ရှိ / အလုပ်မရှိ အခြေအနေကို ပြသည်။",
     subtitleJob: "",
    ...
    noSalary: "ဝင်ငွေနှင့် ရာထူးဒေတာ မတွေ့ပါ။",
