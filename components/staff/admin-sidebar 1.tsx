...
export default function AdminSidebar({
  ...
  const basePaths: Record<ActivePage, string> = {
    dashboard: "/admin/dashboard",
    users: "/admin/users",
    "users-graduated-years": "/admin/users/graduated-years",
    "users-salary-ranges": "/admin/users/salary-ranges",
    "users-job-status": "/admin/users/job-status",
    "manage-users": "/admin/manage-users",
    jobs: "/admin/jobs",
    posts: "/admin/posts",
    "register-users": "/admin/register-users",
    contact: "/admin/contact",
  };

  const currentPath = basePaths[active] || pathname || "/admin/dashboard";

  const makeHref = (path: string, nextLang = currentLang) => {
