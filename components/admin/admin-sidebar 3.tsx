  ...
  const labels = useMemo(
    () => ({
      en: {
        ...
        jobs: "Manage Jobs",
        posts: "Manage Posts",
        registerUsers: "Student Registration Lists",
        contact: "Contact",
        logout: "Logout",
        english: "English",
        myanmar: "Myanmar",
      ...
      mm: {
        ...
        salaryRanges: "လစာနှုန်း အပိုင်းအခြား",
        jobStatus: "ဘွဲ့ရအလုပ်အကိုင် အခြေအနေ",
        manageUsers: "အသုံးပြုသူ စီမံခန့်ခွဲမှု",
      ...
      >
        <div className="flex min-h-0 flex-1 flex-col p-4">
          ...
          <nav className="min-h-0 flex-1 space-y-2 overflow-y-auto pr-1">
            <NavLinkItem item={navs[0]} active={active} collapsed={collapsed} closeMobile={() => setMobileOpen(false)} />
